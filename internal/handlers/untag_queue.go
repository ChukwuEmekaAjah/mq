...
// UntagQueue removes tags on a queue
func UntagQueue(store *mq.Store, w http.ResponseWriter, req *http.Request) {
	...
	set, err := store.UpdateQueue(req.PathValue("queueName"), requestBody.TagKeys)
